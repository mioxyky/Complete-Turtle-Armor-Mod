 ...
 * Registers items via DeferredRegister, creative tab, and tick handlers.
 */
@Mod("turtle_armor")
public class TurtleArmorForge {

    public static final String MOD_ID = "turtle_armor";
    public static final Logger LOGGER = LoggerFactory.getLogger(MOD_ID);

    public TurtleArmorForge() {
        ...
        ModLoadingContext.get().registerExtensionPoint(
            ...
            () -> net.minecraftforge.fml.config.ModConfig.create()
        );

        // Register tick handler for armor effects
        MinecraftForge.EVENT_BUS.register(TurtleArmorEffects.class);

        LOGGER.info("Complete Turtle Armor initialized (Forge)");
    }
